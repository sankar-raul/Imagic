...
const Header = () => {
  return (
    <header className="sticky top-0 mt-0 flex justify-between items-center pt-4 pb-2 px-8 gap-4">
      <div className="h-15">
        <img
          className="h-full"
              ...
              <div className="h-full flex items-center group" key={index}>
                <NavLink
                  ...
                  className={({ isActive, isPending, isTransitioning }) => {
                    return (
                      `border group border-transparent px-4 py-4 after:content-[''] after:absolute after:w-0 after:h-1 after:mb-4.5 after:bg-yellow-50 after:-bottom-2 after:cursor-pointer hover:after:w-[40%] after:left-1/2 after:-translate-x-1/2 after:transition-all after:duration-500 relative after:ease-out ` +
                      (isActive ? "after:w-4" : "")
                    );
                  }}
                  to={link}
