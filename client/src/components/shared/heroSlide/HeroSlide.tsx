...
const HeroSlide = () => {
  return (
    <motion.main initial={{
      ...
      duration: 0.8,
    }} className="h-[calc(100dvh-80px)] flex min-w-dvw max-w-dvw shrink-0 snap-start will-change-transform
">
    <motion.div
          whileInView={{
            opacity: 1,
          ...
          className="my-50 ml-50 flex flex-col gap-4">
            <p className="text-xl border-l-4 pl-4 border-yellow-400 tracking-wider">
            ...
            <div className="flex flex-col gap-6">
              ...
              <h2 className="text-4xl font-medium text-muted-text">
                Join Graphics Design Course
              </h2>
            </div>
            <div className="mt-6 flex gap-4">
              ...
              <button className="bg-white/80 hover:bg-white/90 text-deep-brand px-6 py-3 rounded-full font-semibold shadow-xs transition-shadow duration-300 hover:shadow-lg">
                Learn More
              </button>
            </div>
          ...
          <div className="relative flex items-center justify-center mt-8">
            <img
              ...
              className="max-w-md"
            />
            <div className="absolute top-8 right-1/4 bg-white rounded-full px-6 py-3 shadow-lg border-2 border-blue-200">
              <span className="text-blue-600 font-semibold text-lg">
                20% OFF
              </span>
            </div>
            <div className="absolute bottom-12 left-1/4 bg-white rounded-lg px-6 py-4 shadow-lg flex items-center gap-3">
              <div className="flex items-center gap-2">
