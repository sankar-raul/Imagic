...
const TestimonialSlider = () => {
  ...
  const testimonials = [
    {
      ...
      quote: "Akshay from Hooghly, after completing video editing course from IMAGIC, he joined job as a Video Editor. Now he works at Aaj Tak Bangla.",
    ...
    },
    {
      ...
      quote: "Protyusha Saha from Arambagh got her job before her 1 year Diploma in Digital Media & Marketing Course completion. Now she can learn and also earn as a Digital Marketer at VS Digitech Technology",
    ...
    },
    {
      ...
      company: "MCCIT",
      image: "https://imagic.net.in/wp-content/uploads/2025/09/riya-roy-250x250-1.webp",
      quote: "Riya from Dum Dum got Graphics Design job after her course Completion. She learned one year Diploma in Graphics Design  from IMAGIC and now joined as a Graphics Designer at MCCIT.",
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="max-w-6xl w-full bg-white rounded-2xl shadow-lg p-12 relative">
        ...
        <div className="text-center mb-8">
          <p className="text-gray-800 font-semibold text-lg">
            ...
            <span className="text-gray-500 font-normal">, {currentTestimonial.role}</span>
          </p>
        </div>
