...
import { Briefcase, MapPin, Calendar, DollarSign, Users, Clock, Building } from 'lucide-react';
...
export default function JobListingPage() {
  ...
  const validateForm = () => {
    const newErrors = {};
    if (!formData.fullName.trim()) newErrors.fullName = 'The field is required.';
    if (!formData.phoneNumber.trim()) newErrors.phoneNumber = 'The field is required.';
          ...
          <div className="lg:col-span-2">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-4">
                <div className="flex-1 w-full">
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-4">
                    <span className="text-gray-700 font-medium text-sm sm:text-base">{job.company}</span>
                    <div className="flex items-center gap-1">
                      <span className="text-yellow-500">⭐</span>
                      <span className="text-gray-700 text-sm sm:text-base">3.4</span>
                      <span className="text-gray-500 text-xs sm:text-sm">41340 Reviews</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 text-gray-600 text-sm sm:text-base">
                    ...
                    <div className="flex items-center gap-2">
                      <DollarSign size={16} className="sm:w-5 sm:h-5 shrink-0" />
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
             {job.details.map((point, index) => (
                      <div key={index}>
                       <h2 className='text-2xl font-bold text-black my-6 border-l-4 border-black pl-3'>{point.title}</h2>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 lg:sticky lg:top-8">
              ...
              <div className="space-y-4 sm:space-y-5">
                ...
                <div>
                  ...
                  />
                  {errors.phoneNumber && (
                    <p className="text-red-600 text-xs sm:text-sm mt-1">{errors.phoneNumber}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.captcha && (
                    <p className="text-red-600 text-xs sm:text-sm mt-1">{errors.captcha}</p>
                  )}
                </div>
